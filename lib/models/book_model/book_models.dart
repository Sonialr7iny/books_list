...
final List<BookModel> books = [
  BookModel(
      ...
      bookImage: Image(image: AssetImage('images/fyodor.jpg'),),
      // NetworkImage(
  ...
  BookModel(
    ...
    author: 'Victor Hugo',
    bookImage:Image(image: AssetImage('images/hugo.jpg'),),
  ...
  BookModel(
    ...
    name: 'The Strange',
    author: 'Albert Camus',
    bookImage:Image(image: AssetImage('images/albert.jpg'),),
  ...
  BookModel(
    ...
    bookImage:Image(image: AssetImage('images/madonna.jpg'),),
  ...
  BookModel(
      ...
      bookImage:Image(image: AssetImage('images/utopia.jpg'),),
